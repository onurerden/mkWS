...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <br/>
        <a href="/mkWS/getFollowMeOnMap?routeId="<% out.println(Integer.parseInt(request.getParameter("routeId")) - 1);%> > Önceki </a>
        <a href="/mkWS/getFollowMeOnMap?routeId="<% out.println(Integer.parseInt(request.getParameter("routeId")) + 1);%> > Sonraki </a>        
    </body>
