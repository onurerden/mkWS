 ...
 * @author oerden
 */
@WebServlet(name = "DeleteMapMyRideToken", urlPatterns = {"/DeleteMapMyRideToken"})
public class DeleteMapMyRideToken extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(server.deleteMapMyRideToken(userId)){
