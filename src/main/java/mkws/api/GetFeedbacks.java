 ...
 * @author onurerden
 */
@WebServlet(name = "GetFeedbacksApi", urlPatterns = {"/api/GetFeedbacks"})
public class GetFeedbacks extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!token.isIsAdmin()) {
                response.setStatus(402);
                out.print("{\"result\": \"failed\", \"description\" : \"You don't have admin privileges.\"}");
                out.close();
                return;
            }            
            ...
            feedbackList = server.getFeedbacks();
