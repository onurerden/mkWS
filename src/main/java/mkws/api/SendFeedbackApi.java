 ...
 * @author onurerden
 */
@WebServlet(name = "SendFeedbackApi", urlPatterns = {"/api/SendFeedback"})
public class SendFeedbackApi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            feedbackMessage = request.getParameter("feedbackMessage");
        } catch (Exception ex) {
...
server.sendFeedback(feedbackMessage);
            out.print("{\"result\": \"success\", \"description\" : \"\"");
